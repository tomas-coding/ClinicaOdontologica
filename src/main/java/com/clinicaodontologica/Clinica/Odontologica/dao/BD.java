...
public class BD {
    ...
    private static final String SQL_DROP_CREATE="DROP TABLE IF EXISTS PACIENTES; CREATE TABLE PACIENTES " +
            ...
            "DROP TABLE IF EXISTS ODONTOLOGOS; CREATE TABLE ODONTOLOGOS (ID INT AUTO_INCREMENT PRIMARY KEY,MATRICULA VARCHAR(20) NOT NULL, NOMBRE VARCHAR(30) NOT NULL, APELLIDO VARCHAR(40) NOT NULL) " +
            "";
